...
- Filmarks/読書メーター同期スクリプトの本体は [sync-gateway](https://github.com/ojimpo/sync-gateway) リポジトリにある
- 葛飾区図書館同期は [kashidashi-app](https://github.com/ojimpo/kashidashi-app) と連携
